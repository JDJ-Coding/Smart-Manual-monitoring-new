    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-zinc-800 flex-shrink-0">
          ...
          <button
            onClick={onClose}
            className="text-zinc-500 hover:text-zinc-300 transition-colors p-1 rounded flex-shrink-0"
            aria-label="닫기"
          >
            <X size={16} />
          </button>
                  ...
                  <div className="flex items-center gap-1.5 flex-wrap">
                    ...
                    {(src.fullText || src.excerpt) && (
                      <button
                        ...
                        className="ml-auto flex items-center gap-1 text-[10px] text-zinc-600 hover:text-blue-400 transition-colors flex-shrink-0"
                        title="원문 전체 보기"
                        aria-label="원문 전체 보기"
                      >
                        <Maximize2 size={9} />
